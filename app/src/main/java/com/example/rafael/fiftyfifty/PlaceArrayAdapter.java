    ...
    private ArrayList<PlaceAutocomplete> getPredictions(CharSequence constraint) {
        if (mGoogleApiClient != null) {
            ...
            while (iterator.hasNext()) {
                ...
                resultList.add(new PlaceAutocomplete(prediction.getPlaceId(), prediction.getFullText(characterStyle)));
            }
    ...
    public Filter getFilter() {
        Filter filter = new Filter() {
            ...
            protected FilterResults performFiltering(CharSequence constraint) {
                ...
                if (constraint != null) {
                    mResultList = getPredictions(constraint); // Query the autocomplete API for the entered constraint
                    if (mResultList != null) {
                        results.values = mResultList; // Results
